...
🚀哈喽～各位宝子们周二早上好~~👋！今日为大家带来的是关于漏洞报告的内容，这一次是关于**某平台 CMS 系统后台漏洞的报告**  
，宝子们可以通过报告学习到一些思路和测试方式，不仅仅要练习靶场，还要在实战中学会如何发现以及测试靶场，接下来进行详细的报道；以下的详细内容👇  
## 2. 漏洞报告详情内容  
# 漏洞背景与发现  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvKlKgEazvk2muM57cb92TF4KbqbvulpWfcrGMVBS8YZYTn6sv0Nt1VzFsNCjMujVfNgCMtScic5EqOs4G62eBjBYpX1qa3ywicXA/640?wx_fmt=png&from=appmsg "")  
  
站点登录界面，记录当前的三个账户，  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/icCLY10D8tvKydt4W2WKqLjXHbhANyjMLt8Jacn1mw81CkY5m1u4MUXDFxRy1BkibtLqFCcxOkaKyw35xkIkfCJvFOHcyJnEN9XRFSGTnk9HU/640?wx_fmt=png&from=appmsg "")  
  
拦截登录的信息，修改图中type的值为-1，成功登录系统  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvISSR9VYyEefL6RF8OEfd6BWWrmFg4nYWiagUEXe8rmHHxAkdIctBINblIEMzBWkxT6UMqz69HqyEnnJXjgc6ic2yRo6JtAAxKXc/640?wx_fmt=png&from=appmsg "")  
  
意见返回处存在大量手机号信息  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvJSGOIZRMJHg4gHYgpHsDpjRmCbvswPiaBauT8DwWD53kic7HjJFbv6pWuTY94FUbic4wXHw2mKjIoxC0KiaHHjVavoOeCG1CQWwJw/640?wx_fmt=png&from=appmsg "")  
  
用户查询页面，通过返回的数据粗略估计有90多条用户及信息  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvLXPgTKyu0w2rsfRaiclumlLeWlXr2t4qFHSgwwht8baoX2ibHiaWZia8X0rcqcuCJr1vx47NXtJuGOpBdl9apTtXBspGhuWwZrkb0/640?wx_fmt=png&from=appmsg "")  
## 安全影响  
...
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvIeKG6fPt0n4rmkmLBzrO7SSklwbHmma3fH4Nb8JYhzWUZht6ggBMy8etvFfy7jzAX3kuze67zwgkcIHTdpSRw8BLHImYfsAbc/640?wx_fmt=png&from=appmsg "")  
  
你可以尝试问一下关于打靶场的问题  
  
![](https://mmbiz.qpic.cn/mmbiz_png/icCLY10D8tvIWemVM29FUHezdwTpOTTClfdYCR3g853UWk8QEBspMNAfkK2QA0kzVBnJYxDgurbBHUrOK9l36ggFj6aebwpkbptfmwBdhODQ/640?wx_fmt=png&from=appmsg "")  
## 🚀好靶场会员订阅  
