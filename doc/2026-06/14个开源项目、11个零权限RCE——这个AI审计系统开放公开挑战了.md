...
审计目标涵盖：Jenkins（全球 CI/CD 基石）、LiteLLM（LLM 代理网关）、phpMyAdmin（最广泛的 MySQL 管理工具）、AcePanel（运维面板）、Grav CMS、New API、Redash、Aave V4 等知名开源项目。另有 4 个已发现零权限 RCE 的项目因安全责任考量隐去名称。  
